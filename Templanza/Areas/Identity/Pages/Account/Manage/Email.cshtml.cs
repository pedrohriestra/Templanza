    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Te enviamos un link de confirmación al nuevo email. Revisá tu bandeja de entrada.";
                return RedirectToPage();
            }

            StatusMessage = "Tu email no cambió.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Te enviamos un email de verificación. Revisá tu bandeja de entrada.";
            return RedirectToPage();
        }
    }
}
